...
// @Component
// @Scope("prototype")
// public class Withdraw implements Supplier<ListenableFuture<WithdrawResponse>> {
...
//
// @Override
// public ListenableFuture<WithdrawResponse> get() {
// ListenableFuture<WithdrawResponse> withdrawResponseLF = null;
// withdrawResponseLF = futureStub.withdraw(WithdrawRequest.newBuilder().setUserID(userID)
