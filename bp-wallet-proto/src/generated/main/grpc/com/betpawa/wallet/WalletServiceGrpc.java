...
public final class WalletServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.betpawa.wallet.DepositRequest,
      com.betpawa.wallet.DepositResponse> getDepositMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "deposit",
      requestType = com.betpawa.wallet.DepositRequest.class,
      responseType = com.betpawa.wallet.DepositResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.betpawa.wallet.DepositRequest,
      com.betpawa.wallet.DepositResponse> getDepositMethod() {
    io.grpc.MethodDescriptor<com.betpawa.wallet.DepositRequest, com.betpawa.wallet.DepositResponse> getDepositMethod;
      ...
      synchronized (WalletServiceGrpc.class) {
        if ((getDepositMethod = WalletServiceGrpc.getDepositMethod) == null) {
          WalletServiceGrpc.getDepositMethod = getDepositMethod = 
              io.grpc.MethodDescriptor.<com.betpawa.wallet.DepositRequest, com.betpawa.wallet.DepositResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "wallet.WalletService", "deposit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.betpawa.wallet.DepositRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.betpawa.wallet.DepositResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.betpawa.wallet.WithdrawRequest,
      com.betpawa.wallet.WithdrawResponse> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "withdraw",
      requestType = com.betpawa.wallet.WithdrawRequest.class,
      responseType = com.betpawa.wallet.WithdrawResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.betpawa.wallet.WithdrawRequest,
      com.betpawa.wallet.WithdrawResponse> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.betpawa.wallet.WithdrawRequest, com.betpawa.wallet.WithdrawResponse> getWithdrawMethod;
    if ((getWithdrawMethod = WalletServiceGrpc.getWithdrawMethod) == null) {
      synchronized (WalletServiceGrpc.class) {
        if ((getWithdrawMethod = WalletServiceGrpc.getWithdrawMethod) == null) {
          WalletServiceGrpc.getWithdrawMethod = getWithdrawMethod = 
              io.grpc.MethodDescriptor.<com.betpawa.wallet.WithdrawRequest, com.betpawa.wallet.WithdrawResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "wallet.WalletService", "withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.betpawa.wallet.WithdrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.betpawa.wallet.WithdrawResponse.getDefaultInstance()))
  ...
  public static abstract class WalletServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void deposit(com.betpawa.wallet.DepositRequest request,
        io.grpc.stub.StreamObserver<com.betpawa.wallet.DepositResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getDepositMethod(), responseObserver);
    }

    /**
     */
    public void withdraw(com.betpawa.wallet.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.betpawa.wallet.WithdrawResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.betpawa.wallet.DepositRequest,
                com.betpawa.wallet.DepositResponse>(
                  this, METHODID_DEPOSIT)))
          .addMethod(
            getWithdrawMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.betpawa.wallet.WithdrawRequest,
                com.betpawa.wallet.WithdrawResponse>(
  ...
  public static final class WalletServiceBlockingStub extends io.grpc.stub.AbstractStub<WalletServiceBlockingStub> {
    ...
    /**
     */
    public com.betpawa.wallet.DepositResponse deposit(com.betpawa.wallet.DepositRequest request) {
    ...
    /**
     */
    public com.betpawa.wallet.WithdrawResponse withdraw(com.betpawa.wallet.WithdrawRequest request) {
      return blockingUnaryCall(
  ...
  public static final class WalletServiceFutureStub extends io.grpc.stub.AbstractStub<WalletServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.betpawa.wallet.DepositResponse> deposit(
        com.betpawa.wallet.DepositRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.betpawa.wallet.WithdrawResponse> withdraw(
        com.betpawa.wallet.WithdrawRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DEPOSIT:
          serviceImpl.deposit((com.betpawa.wallet.DepositRequest) request,
              (io.grpc.stub.StreamObserver<com.betpawa.wallet.DepositResponse>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.betpawa.wallet.WithdrawRequest) request,
              (io.grpc.stub.StreamObserver<com.betpawa.wallet.WithdrawResponse>) responseObserver);
          break;
  ...
  private static abstract class WalletServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.betpawa.wallet.WalletClass.getDescriptor();
    }
